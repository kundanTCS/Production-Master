trigger Del_Manager_Job_Share on SmartCharts__Sub_Contract__c (before update) 
{
system.debug('Vasanth..................... '); 
    ...
    if(trigger.isInsert || trigger.isUpdate)
    {
            ...
            for(SmartCharts__Sub_Contract__c job : trigger.old)
            {
                ...
                system.debug('Kundan123..................... '); 
    
                // Specify that the Hiring Manager should have edit access for 
                // this particular Job record.
                hiringManagerShare.AccessLevel = 'edit';
                
                SmartCharts__Sub_Contract__Share s = [Select Id from SmartCharts__Sub_Contract__Share where AccessLevel=:'Edit'];
                Delete s;
          //      update hiringManagerShare;
